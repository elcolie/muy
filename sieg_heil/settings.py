"""
Django settings for sieg_heil project.
...
SECRET_KEY = 'fl9c)32nfbdzufs*i=8fjtnxd1-77@&oil8o1v_s(j7%@+hp4-'
...
WSGI_APPLICATION = 'sieg_heil.wsgi.application'
